...
// const successToast = (message: string) => showToast('success', 'Success!', message);
...
const toastConfig: ToastConfig = {
  ...
  info: props => (
    <BaseToast
      {...props}
      style={{borderLeftColor: '#000', backgroundColor: '#fff'}}
      contentContainerStyle={{paddingHorizontal: 15}}
      text1Style={{
        fontSize: 16,
        fontWeight: 'bold',
...
const errorToast = (message: string) => showToast('error', 'Error!', message);
const successToast = (message: string) => showToast('success', 'Success!', message);
const infoToast = (message: string) => showToast('info','Caution!', message);
export {Toast, toastConfig, showToast, errorToast, successToast, infoToast};