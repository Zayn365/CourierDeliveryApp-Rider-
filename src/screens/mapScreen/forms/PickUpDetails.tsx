...
//     console.log("Selected image:", image); // Debug the input
//     setImage([image]); // Ensure this is { photoUrl: "some/path" }
            ...
            <View style={homeStyles.card}>
              ...
              {packageData?.paymentType === 1 ? (
                <CustomButton
                  ...
                  //@ts-ignore
                  customStyle={{ marginTop: -10, backgroundColor: packageData.amountReceived ? "#4CD964": null }}
                  text={
                    packageData.amountReceived ? (
                      <View
                        style={{
